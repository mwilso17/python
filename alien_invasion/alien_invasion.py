...
class AlienInvasion:
  ...
  def _update_bullets(self):
    """Update position of bullets and get ride of off screen bullets."""
  ...
  def _check_bullet_alien_collisions(self):
    ...
    if not self.aliens:
      # Destroy bullets adn create new fleet.
      self.bullets.empty()
      self._create_fleet()
  ...
  def _ship_hit(self):
    ...
    # Get rid of aliens and bullets left on screen.
    self.aliens.empty()
    self.bullets.empty()
  ...
  def _update_aliens(self):
    """Check if alien at edge, then update the positions of all aliens on the screen."""
    self._check_fleet_edges()
    self.aliens.update()

    # Look for collisions with the player ship.
