...
# punctuation with quotes if off (showing the word 'night"' as different than 'night'). Validation for user inputs. 
# Put code into class.
...
words_per_minute = input("please enter your reading speed in words per minute: ")
reading_time = input("How many minutes each day do you plan on reading?: ")

wmp_int = int(words_per_minute)
time_int = int(reading_time)
